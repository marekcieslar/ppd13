let plan = {
    months: [{
        ...
        days: [{
            ...
            description: 'Niektóre niepowodzenia są tak poważne, że poddanie się im oznacza przegranie całej gry. Kiedy generał Matthew Ridgway* przejmował dowództwo w wojnie koreańskiej, jego siły były zepchnięte daleko na wschód, pod silnym naporem wroga, Tylko zdeterminowana decyzja utrzymania linii pozwoliła siłom amerykańskim obronić się przed zepchnięciem do morza, a potem odzyskać stracone terytorium.<br>Kiedy uderza porażka, możesz nie mieć czasu na wycofanie się i przemyślenie błędów bez ryzyka niepowodzenia. Nie ulegaj paraliżowi. W takiej chwili ważne jest wiedzieć, czego naprawdę pragniesz i tak działać, aby uchronić swoje zasoby i nadzieje. Jeśli kompletnie się rozsypiesz, przyjmiesz cios w poczucie własnej wartości, który będzie trudny do naprawienia. W zamian przylgnij do swych zasad, a będziesz przynajmniej wiedział, że ochroniłeś, to co masz najcenniejszego.<br><br>*Matthew ridgway, w 1950 r. dowódca amerykańskiej 8 armii i wojsk lądowych ONZ w Korei, w 1951 r. głównodowodzący wojs ONZ w Korei i dowódca sił sprzymierzonych w Japonii;'
        }, {
            day: 9,
        ...
        days: [{
            ...
            day: 8,
            motto: 'szczęście można pomnożyć dzieląc się nim z innymi; to jedyny nabytek, który rośnie, gdy jest rozdawany',
            description: 'Ze szczęściem dzieje się tak, że im więcej dajesz, tym obficiej dostajesz. Największe satysfakcje w życiu nie płyną z nagromadzenia środków pieniężnych. Wynikają z psychicznej gratyfikacji, jaka towarzyszy pomaganiu innym w osiąganiu szczęścia. Ci, którzy zdobywają największe bogactwa w życiu, odkryli, jak połączyć obie sprawy. Nauczyli się, w jaki sposób zapewnić dobrą usługę, przynoszącą satysfakcję klientom i generującą zyski dla nich samych.<br>Podchodząc do pracy ze szczodrością i determinacją wywołania zadowolenia klienta z wyboru ciebie jako partnera w interesach przyczyniasz się do własnych, niemałych korzyści. Nigdy nie będzie za dużo szczęśliwych ludzi, którzy dzielą swą radość z innymi.'
        }, {
            day: 9,
            motto: 'uśmiech to drobna rzecz, która może przynieść całkiem spore rezultaty',
            description: 'W świecie zwierząt odsłanianie zębów to pewny znak agresji, ale w świecie istot ludzkich jest odwrotnie. Nic nie rozbraja zagniewanej czy agresywnej osoby szybciej niż ciepły, serdeczny uśmiech. Szczery uśmiech zawsze zapewni ci miłe przyjcie, a kiedy prośbie o pomoc towarzyszy uśmiech prawdziwej przyjaźni, to szybko znajdziesz więcej pomocy niż potrzebujesz.<br>Ćwicz uśmiechanie się do innych, aż przesyłanie miłego uśmiechu stanie się naturalną reakcją na spotkanie z innymi - kiedy jesteś komuś przedstawiany, gdy witasz starego przyjaciela, czy kiedy po prostu każdego ranka przychodzisz do pracy. Upewnij się jednak, że twój uśmiech jest prawdziwy. Inni błyskawicznie wykryją oszustwo, a nic nie odpycha ludzi skuteczniej niż sztuczny uśmiech, za którym nie stoi prawdziwe uczucie.'
        }, {
            day: 10,
            motto: 'szczęście odnajduje się działaniu - nie w samym posiadaniu',
            description: 'To prawda. Pieniądze nie mogą kupić szczęścia. Większość z nas jest motywowana aspiracjami do stylu życia, jakiego pragniemy dla siebie i swoich rodzin, a nie fizycznym posiadaniem - domów, szans na luksusowe wakacje, samochodów itd. Kiedy uznasz  ten fakt, będziesz wiedział, że musisz stale "podnosić poprzeczkę", aby zachęcić siebie do zdobywania wyższych celów. Twoje cele powinny także zawierać dobra materialne, jakich pragniesz, ale jak to powiedział dawny prezez Apple COmputer, John Sculley: "Sukces jest podróżą, a nie miejscem przeznaczenia. Dopilnuj, byś się cieszył z wyprawy".'
        }, {
            day: 11,
            motto: 'nie możesz znaleźć szczęścia okradając zeń kogoś innego; to samo dotyczy poczucia bezpieczeństwa finansowego',
            description: 'Niewiele istnieje na tym świecie rzeczy, które wzbogacą ciebie, jeśli pozbawidsz ich innych. Na ogół prawda jest odwrotna. Kiedy dzielisz się bogactwem i szczęściem, powiększasz własny udział w obu. Właściwie ani szczęście, ani bezpieczeństwo finansowe nie ma wielkiej wartości, jeśli nie jest dzielone. Szczęścia nie można gromadzić i odkładać, aż będzie potrzebne, a poczucie bezpieczeństwa należy do pojęć abstrakcyjnych. Generał Douglas MacArthur zauważył kiedyś: "W życiu nie ma bezpieczeństwa. Istnieje tylko okazja". Musisz odnaleźć szczęście i bezpieczeństwo finansowe dla samego siebie i dzielić je, by je zachować.'
        }, {
            day: 12,
            motto: 'uśmiech poprawia twój wygląd, sprawia, że czujesz się lepiej i nic przy tym nie kosztuje',
            description: 'Przebłysk uśmiechu jest naturalną reakcją, kiedy znajdziemy się przed kamerą. Instynktownie wiemy, że wyglądamy bardziej pociągająco i atrakcyjnie, gdy się uśmiechamy. Kiedy uśmiechamy się do innych, wywołuje to korzystną reakcję z ich strony, ale co ważniejsze, powoduje też, że sami czujemy się lepiej. Nie wynika to wyłącznie z zasad psychologii. Eksperci w tej dziedzinie odkryli, że uśmiechanie się powoduje zmiany w procesach chemicznych przebiegających w naszym ciele i rzeczywiście dzięki uśmiechowi zyskujemy poczucie szczęścia i zdrowia.<br>Kiedy zachowujesz uśmiech w swyj głosie, inni porzucają postawę obronną i otwierają się na ciebie - osobiście czy przez telefon. Pracownicy spędzający dużo czasu na rozmowach telefonicznych wiedzą o tym, że ludzie, z kttórymi konwesrują, potrafią "usłyszeć" uśmiech w ich głosie. Jeśli pamiętanie o przyjemnym tonie głosu sprawia ci trudności, trzymaj małe lusterko przy aparacie telefonicznym, by sprawdzić, czy uśmiechasz się, kiedy mówiesz.'
        }, {
            day: 13,
            motto: 'każdego człowieka można łatwiej zdobyć przez miłość niż przez nienawiść',
